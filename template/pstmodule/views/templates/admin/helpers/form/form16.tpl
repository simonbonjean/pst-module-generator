...
*}
<style>
    #pst_superblock_form > .panel{
        float: left;
        width: 41%;
        margin-left: 3%;
    }
    #pst_superblock_form #fieldset_0{
        width: 55%;
        margin-left: 0;
    }
</style>
...
{block name="defaultForm"}
    ...
    {foreach $fields as $f => $fieldset}
        {block name="fieldset"}
        <div class="panel{if isset($fieldset.class)} type_box box-{$fieldset.class}{/if}" id="fieldset_{$f}">
                                ...
                                <div class="col-lg-{if isset($input.col)}{$input.col|intval}{else}9{/if} {if !isset($input.label)}col-lg-offset-3{/if}">
                                    {block name="input"}
                                        ...
                                        {elseif $input.type == 'select_product'}
                                            ...
                                            <br /><br />
                                            <div id="products_found" class="module_confirmation conf confirm" style="display: none;"></div>
                                            <div id="products_err" class="warn" style="display: none;">No products found</div>
                                        {elseif $input.type == 'select_html'}
                                            <select name="{$input.name}" id="{$input.name}">
                                                {$input.options.html}
                                            </select>
                                        ...
                                        {elseif $input.type == 'checkbox'}
                                            ...
                                            {/foreach}
                                        {elseif $input.type == 'checkbox_html'}
                                            {if isset($input.expand)}
                                                <a class="btn btn-default show_checkbox{if $input.expand.default == 'hide'} hidden {/if}" href="#">
                                                    <i class="icon-{$input.expand.show.icon}"></i>
                                                    {$input.expand.show.text}
                                            ...
                                            <div class="row">
                                                <div class="input-group col-lg-4">
                                                    <input
                                                            ...
                                                            type="text"
                                                            data-hex="true"
                                                            {if isset($input.class)}class="datepicker {$input.class}"
                                            ...
                                            <div class="row">
                                                <div class="input-group col-lg-4">
                                                    <input
                                                            ...
                                                            type="text"
                                                            data-hex="true"
                                                            {if isset($input.class)}class="datetimepicker {$input.class}"
